...
These notes remain open and unscheduled. Use Northstar Atlas with the
operator to choose the next strategic runway; do not promote a note into a
task without that direction.
