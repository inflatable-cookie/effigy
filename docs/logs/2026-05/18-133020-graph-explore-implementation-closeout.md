...
| `find graph status stale detection` | `docs/logs/2026-05/18-131500-tighten-stale-and-status-scan-cost.md` | 2.14s | weak top owner; direct verification still needed |
