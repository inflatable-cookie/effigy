...
batch stays anchored on the demo release-readiness checkpoint instead of
widening back into implementation churn or jumping ahead into release execution.
