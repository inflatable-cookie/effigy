...
product decision stays anchored on attached human terminal interaction and the
runner-owned session contract instead of widening into browser text-entry
polish or nested TUI embedding by habit.
