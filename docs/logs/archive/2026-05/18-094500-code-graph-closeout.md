...
- `cargo fmt --all -- --check`
- `./target/debug/effigy docs check paths docs/roadmaps/g07 docs/roadmaps/README.md docs/roadmaps/generation-index.md docs/specs/085-code-graph-intelligence-strict-lane.md docs/specs/README.md docs/logs/README.md docs/logs/archive/2026-05/18-082531-agent-context-packs.md docs/logs/archive/2026-05/18-094500-code-graph-closeout.md docs/guides/025-command-reference-matrix.md`
- `git diff --check`
