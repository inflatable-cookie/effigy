...
| `find graph status stale detection` | `docs/logs/archive/2026-05/18-131500-tighten-stale-and-status-scan-cost.md` | 1.88s | weak owner result; likely broad follow-up search |
