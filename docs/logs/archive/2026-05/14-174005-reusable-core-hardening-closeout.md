...
- `effigy docs check paths docs/roadmaps docs/specs/083-reusable-core-hardening-strict-lane.md docs/logs/archive/2026-05/14-174005-reusable-core-hardening-closeout.md`
- `git diff --check`
