...
- `cargo run --bin effigy -- docs check-links CHANGELOG.md docs/guides/056-northstar-effigy-consumer-repo-contract.md docs/logs/README.md docs/logs/archive/2026-03/12-223500-product-boundary-and-verify-install-ssh-closeout.md docs/logs/archive/2026-03/12-225500-starter-docs-policy-bundle-proof.md docs/roadmaps/g01/029-northstar-effigy-consumer-adoption-kit.md`
