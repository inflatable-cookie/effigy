...
- `cargo run --bin effigy -- docs check-links CHANGELOG.md docs/guides/051-release-orchestration.md docs/guides/056-northstar-effigy-consumer-repo-contract.md docs/logs/README.md docs/logs/archive/2026-03/12-220500-consumer-adoption-closeout-matrix.md docs/logs/archive/2026-03/12-223500-product-boundary-and-verify-install-ssh-closeout.md docs/roadmaps/g01/029-northstar-effigy-consumer-adoption-kit.md`
