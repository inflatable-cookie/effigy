...
- Canonical refs:
  - [003-demo-harness-model-and-runner-contract.md](../../../roadmaps/archive/g02.md)
  - [039-implement-demo-history-query-controls.md](../../../roadmaps/archive/g02.md)
...
- Key files:
  - [demo_command/mod.rs](../../../../src/runner/demo_command/mod.rs)
...
- Stay within `g02.003` runner/query history work under [003-demo-harness-model-and-runner-contract.md](../../../roadmaps/archive/g02.md).
...
- Spec-to-canonical relationship: the strict spec lane is only the execution grammar. The roadmap contract in [003-demo-harness-model-and-runner-contract.md](../../../roadmaps/archive/g02.md) is the canonical promoted surface that the next thread should trust when implementing `039`.
...
Start from [039-implement-demo-history-query-controls.md](../../../roadmaps/archive/g02.md), inspect the current `demo history` CLI and retained-attempt structures, then implement one bounded query-control batch in [demo_command/mod.rs](../../../../src/runner/demo_command/mod.rs), [command_parsing.rs](../../../../crates/effigy-cli/src/command_parsing.rs), [demo.rs](../../../../crates/effigy-cli/src/help/topics/demo.rs), and the matching CLI tests. Keep it one-demo and query-first. A good target is: outcome-focused filtering plus one human-friendly retained-attempt selector alongside the existing stable `--attempt <ATTEMPT_ID>` path.

## Completion Protocol

1. Confirm [039-implement-demo-history-query-controls.md](../../../roadmaps/archive/g02.md) still reflects the exact bounded batch you are about to run.
2. Implement `039`, then update [003-demo-harness-model-and-runner-contract.md](../../../roadmaps/archive/g02.md), the active currentness surfaces, and `docs/logs/README.md` in the same closeout.
...
7. The immediate next task is: execute [039-implement-demo-history-query-controls.md](../../../roadmaps/archive/g02.md) as one substantial runner-side batch.
