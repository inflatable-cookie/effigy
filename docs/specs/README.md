...
Use the active spec lane to control the next `g02.003` coverage/gap planning
batch, then keep this surface trimmed so it reflects live planning rather than
