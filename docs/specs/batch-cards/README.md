...
- [`072-implement-demo-browser-live-concurrent-runner-session-parity.md`](./072-implement-demo-browser-live-concurrent-runner-session-parity.md)

## Next Task

Execute the active ready card to add browser-owned live attached
