# 133 Decide Post-Docs-Policy Foundation Extraction Boundary
...
Execute
[`134-implement-effigy-docs-policy-qa-check-extraction.md`](./134-implement-effigy-docs-policy-qa-check-extraction.md)
to move the remaining docs QA check cluster out of `src/runner/docs_command.rs`.
