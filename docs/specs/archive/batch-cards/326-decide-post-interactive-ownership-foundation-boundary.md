...
- docs-only: `./target/debug/effigy docs check-paths docs/specs/023-interactive-session-ownership-and-lifecycle-convergence-strict-lane.md docs/specs/batch-cards/325-implement-interactive-ownership-classification-foundation.md docs/specs/batch-cards/326-decide-post-interactive-ownership-foundation-boundary.md docs/specs/README.md docs/specs/batch-cards/README.md docs/roadmaps/README.md docs/roadmaps/g03/README.md docs/roadmaps/g03/010-interactive-session-ownership-and-lifecycle-convergence.md`
