...
after PTY-backed demo terminal/session semantics land, while browser tab
convergence, nested TUI embedding, broader runtime expansion, and desktop-
client questions stay separate.
