...
- `docs/knowledge/contracts/005-container-runtime-contract.md` for local runtime guarantees
- `docs/knowledge/contracts/009-execution-surface-convergence.md` for cross-surface
  execution responsibility rules
- `docs/knowledge/contracts/011-runtime-context-contract.md` for boot-time context and
  path authority
- `docs/knowledge/contracts/012-container-manager-contract.md` for backend manager
  ownership
- `docs/knowledge/contracts/013-task-execution-request-contract.md` for task request and
  resolved-plan ownership
- `docs/knowledge/contracts/014-artifact-substrate-contract.md` for artifact transport,
  staging, seed, and dump handoff ownership
- `docs/knowledge/contracts/015-runtime-operation-pipeline-contract.md` for the `g04`
  request/plan/report/adapter pipeline boundaries
- `docs/knowledge/contracts/037-explicit-catalog-membership-contract.md` for root-owned
  catalog membership, typed system mounts, and routing normalization
- `docs/knowledge/architecture/025-external-skill-task-execution.md` and
  `docs/knowledge/contracts/042-external-skill-task-runner-contract.md` for isolated
