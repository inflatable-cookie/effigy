...
- `./target/debug/effigy docs check-paths docs/contracts/008-railway-export-contract.md docs/specs/001-production-deployment-model-and-export-contract-strict-lane.md docs/roadmaps/g04/batch-cards/README.md docs/roadmaps/g03/batch-cards/322-implement-railway-export-foundation.md`
