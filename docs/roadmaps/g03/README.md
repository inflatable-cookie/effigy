...
- [`031-plugin-ready-container-manager-facade.md`](./031-plugin-ready-container-manager-facade.md) (active; lane `038` is open and card `385` is ready)
...
- ready card: [`385-migrate-exec-copy-data-through-manager.md`](../../specs/batch-cards/385-migrate-exec-copy-data-through-manager.md)
