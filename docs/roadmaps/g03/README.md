...
- [`034-dependability-proof-matrix-for-decodelabs-and-underlay-shapes.md`](./034-dependability-proof-matrix-for-decodelabs-and-underlay-shapes.md) (active; lane `040` is open and card `402` is ready)
...
- ready card: [`402-add-bootstrap-target-repo-path-proof.md`](../../specs/batch-cards/402-add-bootstrap-target-repo-path-proof.md)
