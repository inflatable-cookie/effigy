...
- `docs/specs/batch-cards/038-decide-demo-post-history-drilldown-boundary.md`
...
Execute the active ready card for `g02.003` to choose the next bounded
follow-up after historical-attempt drilldown.
