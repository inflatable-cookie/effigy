...
- `docs/specs/batch-cards/035-implement-demo-history-query-foundation.md`
...
Execute the active ready card for `g02.003` to ship a separate result-history
