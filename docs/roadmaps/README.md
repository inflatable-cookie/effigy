...
- `docs/specs/batch-cards/072-implement-demo-browser-live-concurrent-runner-session-parity.md`
...
Execute the active ready card for `g02.003` to add browser-owned live attached
