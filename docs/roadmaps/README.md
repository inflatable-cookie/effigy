...
- `docs/specs/batch-cards/032-decide-demo-attempt-history-and-result-timeline-boundary.md`
...
Execute the active ready card for `g02.003` to decide the first bounded
