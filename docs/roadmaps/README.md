...
Execute the active ready card for `g02.002`, then leave the override/conflict
and explainability contract explicit enough that `g02.003` can design demo
proof on top of one general config model instead of inventing feature-local
file loading.
