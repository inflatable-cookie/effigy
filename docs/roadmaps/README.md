...
- `g02/003-demo-harness-model-and-runner-contract.md` defines first-class demo proof and the runner/browser semantics that should sit inside Effigy; registry loading, inspection, `demo run`, lifecycle control, browser-state/query polish, repo-self-hosted proof demos, browser list/detail foundation, browser artifact-opening affordances, bounded browser live log visibility, and in-browser query controls are now shipped.
...
- `docs/specs/batch-cards/027-decide-demo-post-query-follow-up-boundary.md`
...
follow-up now that query controls are shipped.
