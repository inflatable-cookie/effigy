...
- `docs/specs/batch-cards/074-implement-demo-concurrent-runtime-projection-shape-contract.md`
...
Execute the active ready card for `g02.003` to add runner-owned
concurrent-runtime projection-shape truth for richer concurrent-runner demos.
