...
- `g02/003-demo-harness-model-and-runner-contract.md` defines first-class demo proof and the runner/browser semantics that should sit inside Effigy; registry loading, inspection, `demo run`, lifecycle control, browser-state/query polish, repo-self-hosted proof demos, browser list/detail foundation, browser artifact-opening affordances, and bounded browser live log visibility are now shipped.
...
- `docs/specs/batch-cards/025-decide-demo-post-live-log-follow-up-boundary.md`
...
follow-up now that live log visibility is shipped.
