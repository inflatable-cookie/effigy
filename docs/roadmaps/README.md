...
- `docs/specs/batch-cards/076-implement-demo-concurrent-runtime-projected-process-summary-contract.md`
...
Execute the active ready card for `g02.003` to add bounded projected-process
summary truth for projected concurrent demos.
