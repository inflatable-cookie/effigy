...
- `docs/specs/batch-cards/075-decide-demo-post-concurrent-runtime-projection-shape-boundary.md`
...
after runner-owned concurrent-runtime projection-shape truth landed.
