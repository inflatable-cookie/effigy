...
- `docs/specs/batch-cards/041-implement-demo-browser-history-handoff.md` is
  the current ready card.
...
Execute the active ready card for `g02.003` to add a bounded browser history
handoff on top of the settled one-demo query contract.
