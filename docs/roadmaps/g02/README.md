...
- [`../specs/batch-cards/079-decide-demo-post-projected-output-provenance-boundary.md`](../specs/batch-cards/079-decide-demo-post-projected-output-provenance-boundary.md)
...
projected-output provenance truth landed.
