...
- [`../specs/batch-cards/036-decide-demo-history-query-follow-up-boundary.md`](../specs/batch-cards/036-decide-demo-history-query-follow-up-boundary.md)
...
the shipped `demo history` query surface, while broader runtime expansion
stays deferred.
