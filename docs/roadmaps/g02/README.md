...
- [`../specs/batch-cards/072-implement-demo-browser-live-concurrent-runner-session-parity.md`](../specs/batch-cards/072-implement-demo-browser-live-concurrent-runner-session-parity.md)
...
Use the active `g02.003` ready card to add browser-owned live attached
