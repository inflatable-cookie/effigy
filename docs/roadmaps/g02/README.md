...
- [`../specs/batch-cards/051-implement-demo-pty-terminal-session-contract.md`](../specs/batch-cards/051-implement-demo-pty-terminal-session-contract.md)
...
Use the active `g02.003` ready card to deepen the runner-owned demo
terminal/session contract with PTY-backed interactive semantics, while broader
runtime expansion stays deferred.
