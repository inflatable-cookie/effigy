...
- [`../specs/batch-cards/035-implement-demo-history-query-foundation.md`](../specs/batch-cards/035-implement-demo-history-query-foundation.md)
...
Use the active `g02.003` ready card to ship a separate demo-history query
surface before widening `demo list` or the browser, while broader runtime
