...
- [`../specs/batch-cards/062-implement-demo-active-terminal-resize-contract.md`](../specs/batch-cards/062-implement-demo-active-terminal-resize-contract.md)
...
Use the active `g02.003` ready card to add runner-owned terminal size and
resize handoff for active demo sessions.
