...
- [`005-optional-distribution-surface-contract.md`](./005-optional-distribution-surface-contract.md) (in progress; the first manifest-driven distribution foundation is shipped for package identity, preflight tasks, and metadata requirements, and the next slice is widening publish/summary/closeout policy before any consumer proof)
...
- [`../specs/batch-cards/101-implement-distribution-policy-widening-for-publish-and-closeout.md`](../specs/batch-cards/101-implement-distribution-policy-widening-for-publish-and-closeout.md)
...
Use the active `g02.005` ready card to widen manifest-driven policy across the
