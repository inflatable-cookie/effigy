...
- [`../specs/batch-cards/053-implement-demo-browser-live-terminal-view.md`](../specs/batch-cards/053-implement-demo-browser-live-terminal-view.md)
...
Use the active `g02.003` ready card to let `effigy demo browser` consume the
shipped demo terminal/session contract as a bounded live terminal view before
any later tab convergence work, while broader runtime expansion stays deferred.
