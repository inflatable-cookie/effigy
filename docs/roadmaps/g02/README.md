...
- [`../specs/batch-cards/045-implement-demo-browser-terminal-view.md`](../specs/batch-cards/045-implement-demo-browser-terminal-view.md)
...
Use the active `g02.003` ready card to let the browser consume the
runner-owned active demo terminal/session contract through a bounded terminal
view, while broader runtime expansion stays deferred.
