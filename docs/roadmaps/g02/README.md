...
- [`../specs/batch-cards/063-decide-demo-post-terminal-resize-contract-boundary.md`](../specs/batch-cards/063-decide-demo-post-terminal-resize-contract-boundary.md)
...
active demo terminal resize semantics landed.
