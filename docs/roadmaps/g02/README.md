...
- [`../specs/batch-cards/037-implement-demo-history-attempt-drilldown.md`](../specs/batch-cards/037-implement-demo-history-attempt-drilldown.md)
...
broader runtime expansion stays deferred.
