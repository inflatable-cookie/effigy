...
- [`../specs/batch-cards/042-decide-demo-post-browser-history-handoff-boundary.md`](../specs/batch-cards/042-decide-demo-post-browser-history-handoff-boundary.md)
...
to query-first runner work, while broader runtime expansion stays deferred.
