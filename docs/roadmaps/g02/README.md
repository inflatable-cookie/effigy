...
- [`../specs/batch-cards/078-implement-demo-concurrent-runtime-projected-output-provenance-contract.md`](../specs/batch-cards/078-implement-demo-concurrent-runtime-projected-output-provenance-contract.md)
...
Use the active `g02.003` ready card to add projected-output provenance truth
