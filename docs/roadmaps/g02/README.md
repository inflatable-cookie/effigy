...
- [`../specs/batch-cards/061-decide-demo-post-browser-terminal-emulator-boundary.md`](../specs/batch-cards/061-decide-demo-post-browser-terminal-emulator-boundary.md)
...
Use the active `g02.003` ready card to choose the next bounded slice after
embedded browser terminal emulation and input landed.
