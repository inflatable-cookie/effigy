...
- [`../specs/batch-cards/058-decide-demo-post-panel-first-navigation-boundary.md`](../specs/batch-cards/058-decide-demo-post-panel-first-navigation-boundary.md)
...
Use the active `g02.003` ready card to choose the bounded follow-up after
panel-first demo-browser navigation landed while broader runtime expansion
stays deferred.
