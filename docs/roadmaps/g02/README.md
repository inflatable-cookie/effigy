...
- [`../specs/batch-cards/074-implement-demo-concurrent-runtime-projection-shape-contract.md`](../specs/batch-cards/074-implement-demo-concurrent-runtime-projection-shape-contract.md)
...
Use the active `g02.003` ready card to add runner-owned concurrent-runtime
