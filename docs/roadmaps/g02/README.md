...
- [`../specs/batch-cards/081-validate-demo-browser-on-real-project-cohort.md`](../specs/batch-cards/081-validate-demo-browser-on-real-project-cohort.md)
...
Use the active `g02.003` ready card to trial the shipped demo browser on at
least two real consumer projects before release.
