...
- [`../specs/batch-cards/057-implement-demo-browser-panel-first-navigation.md`](../specs/batch-cards/057-implement-demo-browser-panel-first-navigation.md)
...
Use the active `g02.003` ready card to make demo-browser navigation panel-first
now that user feedback showed the converged tab surface still has the wrong
control model while broader runtime expansion stays deferred.
