...
- [`../specs/batch-cards/052-decide-demo-post-pty-terminal-contract-boundary.md`](../specs/batch-cards/052-decide-demo-post-pty-terminal-contract-boundary.md)
...
PTY-backed demo terminal/session semantics landed, while broader runtime
