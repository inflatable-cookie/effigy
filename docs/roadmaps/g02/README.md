...
- [`../specs/batch-cards/041-implement-demo-browser-history-handoff.md`](../specs/batch-cards/041-implement-demo-browser-history-handoff.md)
...
on top of the settled one-demo query contract, while broader runtime
