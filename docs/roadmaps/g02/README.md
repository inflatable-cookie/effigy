...
- [`../specs/batch-cards/064-implement-demo-runtime-backend-capability-contract.md`](../specs/batch-cards/064-implement-demo-runtime-backend-capability-contract.md)
...
Use the active `g02.003` ready card to add bounded runtime backend and
capability facts for active demo sessions.
