...
- [`003-demo-harness-model-and-runner-contract.md`](./003-demo-harness-model-and-runner-contract.md) (in progress; defines first-class demo proof, runner semantics, coverage/gap model, and TUI browser contract, with registry/inspection, run foundation, lifecycle control, browser-state/query polish, and self-hosted proof demos now shipped)
...
- [`../specs/batch-cards/020-implement-demo-browser-list-detail-foundation.md`](../specs/batch-cards/020-implement-demo-browser-list-detail-foundation.md)
...
Use the active `g02.003` ready card to implement the first bounded demo browser
list/detail foundation next, while broader stoppability stays deferred behind a
