...
| Path and string utilities | `path::join`, `path::file_name`, `str::trim`, `str::contains`, `str::starts_with`, `str::ends_with`, `str::replace`, `str::split_lines`, `str::parse_int`, `str::shell_quote`, `regex::is_match`, `regex::replace`, `regex::captures`, `regex::escape` | Exposed |
