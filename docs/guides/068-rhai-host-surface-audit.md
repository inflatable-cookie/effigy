...
| Path and string utilities | `path::join`, `path::file_name`, `str::trim`, `str::contains`, `str::starts_with`, `str::ends_with`, `str::replace`, `str::split_lines`, `str::parse_int`, `str::shell_quote`, `regex::is_match`, `regex::replace`, `regex::captures`, `regex::escape`, `url::parse`, `url::query_get`, `url::parse_mysql_dsn`, `url::parse_pg_dsn` | Exposed |
...
| Structured data | `json::parse`, `json::stringify`, `json::stringify_compact`, `json::read_file`, `json::write_file`, `toml::parse`, `toml::stringify`, `toml::read_file`, `toml::write_file` | Exposed |
