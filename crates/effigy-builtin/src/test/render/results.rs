...
use super::super::{BuiltinError, BuiltinTestExecResult};
                ...
                (
                    ...
                    (
                        ...
                        match plan.teardown_policy {
                            effigy_manifest::ManifestTestSuiteTeardownPolicy::Always => {
                                "always".to_owned()
                            }
                            effigy_manifest::ManifestTestSuiteTeardownPolicy::OnSuccess => {
                                "on-success".to_owned()
                            }
                        },
                    ),
...
pub(crate) fn finalize_builtin_test_outcome(
    ...
    Err(BuiltinError::BuiltinTestNonZero { failures, rendered })
}
