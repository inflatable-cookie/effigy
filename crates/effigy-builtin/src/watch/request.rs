...
impl WatchRequest {
    pub(super) fn validate_execution_policy(&self) -> Result<(), BuiltinError> {
    ...
    pub(super) fn validated_target(&self) -> Result<&TaskInvocation, BuiltinError> {
...
pub(super) fn parse_watch_request(
    task: &TaskInvocation,
    args: &[String],
) -> Result<WatchRequest, BuiltinError> {
