...
use crate::{
    BootstrapArgs, ChangelogArgs, ChangelogSubcommand, Command, ContainerArgs, ContainerSubcommand,
...
fn parse_container_command<I>(args: I) -> Result<Command, CliParseError>
where
    I: IntoIterator<Item = String>,
{
