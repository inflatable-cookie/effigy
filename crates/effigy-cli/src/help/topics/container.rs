...
const CONTAINER_HELP: StandardTopicHelpSpec = StandardTopicHelpSpec {
    ...
    notices: text_lines![
        ...
        "`container profile status` reports Colima profile sizing against Effigy's managed targets, and `container profile recreate --yes` rebuilds the managed profile at the target size after deleting local profile data.",
