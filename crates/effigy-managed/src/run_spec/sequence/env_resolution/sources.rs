...
pub fn resolve_manifest_env_entry<'a>(
    entry_ref: &str,
...
pub fn resolve_process_env_entry(entry_ref: &str) -> Option<(String, String)> {
...
pub fn resolve_env_schema_entry(
    entry_ref: &str,
    repo_root: &Path,
...
pub fn unknown_env_entry_error(task_name: &str, entry_ref: &str) -> ManagedError {
