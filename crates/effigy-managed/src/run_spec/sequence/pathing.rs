...
pub fn split_catalog_env_reference(entry_ref: &str) -> Option<(&str, &str)> {
...
pub fn resolve_catalog_reference_root(catalog_path: &str, repo_root: &Path) -> PathBuf {
...
pub fn find_catalog_by_normalized_root<'a>(
