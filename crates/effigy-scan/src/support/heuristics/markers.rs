...
pub fn compile_attention_marker_patterns(
...
pub fn compile_stale_suppression_patterns(
...
pub fn attention_marker_matches_line(raw_line: &str, marker_lower: &str) -> bool {
...
pub fn stale_suppression_matches_line(raw_line: &str, marker_lower: &str) -> bool {
    let lower_line = mask_string_literals(raw_line).to_ascii_lowercase();
    match marker_lower {
        "eslint-disable" => {
...
pub fn attention_marker_category(marker_lower: &str) -> AttentionMarkerCategory {
    if marker_lower.contains("deprecat") {
...
pub fn stale_suppression_category(marker_lower: &str) -> StaleSuppressionCategory {
