...
use crate::model::GeneratedInSrcCategory;
...
pub fn is_generated_artifact(rel: &Path, contents: &str) -> bool {
    let lower_name = rel
        .file_name()
...
pub fn generated_asset_reason(rel: &Path, sample: &str) -> Option<String> {
...
pub fn generated_in_src_reason(
    rel: &Path,
    sample: &str,
