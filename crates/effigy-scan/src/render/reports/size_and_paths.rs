...
pub fn render_generated_asset_text(
...
pub fn render_generated_asset_markdown(result: &GeneratedAssetScanResult) -> String {
...
pub fn render_generated_in_src_text(
...
pub fn render_generated_in_src_markdown(result: &GeneratedInSrcScanResult) -> String {
    render_markdown_report(
        MarkdownReportSpec {
            title: "Generated In Src",
            metadata_lines: vec![
