...
pub(crate) fn failed_to_read_path(path: &Path, error: impl std::fmt::Display) -> String {
    format!("failed to read {}: {error}", path.display())
}

pub(crate) fn failed_to_parse_path(path: &Path, error: impl std::fmt::Display) -> String {
    format!("failed to parse {}: {error}", path.display())
}

pub(crate) fn failed_to_write_path(path: &Path, error: impl std::fmt::Display) -> String {
    format!("failed to write {}: {error}", path.display())
}

pub(crate) fn failed_to_render_path(path: &Path, error: impl std::fmt::Display) -> String {
    format!("failed to render {}: {error}", path.display())
}

pub(crate) fn failed_to_parse_toml_syntax_in_path(
    path: &Path,
...
pub(crate) fn strict_manifest_parse_failed_in_path(
    path: &Path,
    error: impl std::fmt::Display,
) -> String {
    format!(
