...
pub(crate) struct PathPresenceCache {
...
impl PathPresenceCache {
    ...
    pub(crate) fn child_exists(&mut self, parent: &Path, child: &str) -> bool {
        self.exists(&parent.join(child))
    }

    pub(crate) fn child_is_file(&mut self, parent: &Path, child: &str) -> bool {
