use super::{create_workspace_dir, fs, write_manifest, EnvGuard, Path};
...
pub(in crate::runner::tests::run_array_tests::execution_controls_tests) fn dag_max_parallel_env(
    parallelism: u32,
) -> EnvGuard {
    EnvGuard::set_many(&[("EFFIGY_DAG_MAX_PARALLEL", Some(parallelism.to_string()))])
}

pub(in crate::runner::tests::run_array_tests::execution_controls_tests) fn write_env_files(
    root: &Path,
    entries: &[(&str, &str)],
) {
...
pub(in crate::runner::tests::run_array_tests::execution_controls_tests) fn write_catalog_manifest_with_alias(
    root: &Path,
    catalog_dir: &str,
    alias: &str,
    body: &str,
...
pub(in crate::runner::tests::run_array_tests::execution_controls_tests) fn write_catalog_api_single_env_capture_manifest(
    root: &Path,
    catalog_dir: &str,
    alias: &str,
    env_step_expr: &str,
...
pub(in crate::runner::tests::run_array_tests::execution_controls_tests) fn write_catalog_api_unreachable_manifest(
    root: &Path,
    catalog_dir: &str,
    alias: &str,
    env_step_expr: &str,
...
pub(in crate::runner::tests::run_array_tests::execution_controls_tests) fn write_root_api_single_env_capture_manifest(
    root: &Path,
    marker: &Path,
    env_prelude: Option<&str>,
    env_step_expr: &str,
...
pub(in crate::runner::tests::run_array_tests::execution_controls_tests) fn write_root_api_dual_env_capture_manifest(
    root: &Path,
    marker: &Path,
    env_prelude: Option<&str>,
    env_step_exprs: &[&str],
...
pub(in crate::runner::tests::run_array_tests::execution_controls_tests) fn write_task_api_env_capture_manifest(
    root: &Path,
    marker: &Path,
    task_env_file_expr: Option<&str>,
    step_env_file_expr: Option<&str>,
...
pub(in crate::runner::tests::run_array_tests::execution_controls_tests) fn write_task_api_env_unreachable_manifest(
    root: &Path,
    task_env_file_expr: Option<&str>,
    step_env_file_expr: Option<&str>,
    env_step_expr: &str,
