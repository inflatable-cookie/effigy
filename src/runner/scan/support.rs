...
pub(in crate::runner) use heuristics::{
    ...
    is_generated_artifact, normalized_code_lines, severity_rank,
    stale_suppression_category, stale_suppression_matches_line, stale_suppression_severity_rank,
    compile_stale_suppression_patterns, trim_snippet, NormalizedCodeLine,
};
#[cfg(test)]
