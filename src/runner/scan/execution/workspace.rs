...
pub(in crate::runner) fn run_workspace_scan<
    TStats,
    TLocalResult,
    TFinding,
    TResult,
...
pub(in crate::runner) fn walk_text_scan_files<ShouldSkip, Visit>(
    root: &Path,
...
#[derive(Default)]
pub(in crate::runner) struct ScanWorkspaceCounts {
    pub(in crate::runner) scanned_files: usize,
    pub(in crate::runner) secondary: usize,
}
