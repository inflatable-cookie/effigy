...
pub(in crate::runner) use file_scans::{
...
pub(in crate::runner) use marker_scans::{
    run_attention_marker_scan_workspace, run_stale_suppression_scan_workspace,
};
pub(super) use workspace::{run_workspace_scan, walk_text_scan_files, ScanWorkspaceCounts};
