...
pub(super) fn parse_cache_request(args: &[String]) -> Result<CacheRequest, RunnerError> {
...
fn parse_inspect_request(mut parser: BuiltinArgParser<'_>) -> Result<CacheRequest, RunnerError> {
...
fn parse_invalidate_request(mut parser: BuiltinArgParser<'_>) -> Result<CacheRequest, RunnerError> {
    let mut output_json = false;
