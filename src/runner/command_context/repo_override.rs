...
pub(in crate::runner) fn command_repo_override(cmd: &Command) -> Option<PathBuf> {
    match cmd {
        ...
        Command::Deps(args) => args.repo_override.clone(),
        Command::Papercuts(_) => None,
        Command::Secrets(args) => args.repo_override.clone(),
        Command::Defer(args) => args.repo_override.clone(),
        Command::Exec(args) => args.repo_override.clone(),
        Command::State(args) => args.repo_override.clone(),
...
pub(in crate::runner) fn apply_repo_target_to_embedded_command(
    ...
    match &mut command {
        ...
        Command::Deps(args) => assign_repo_override(&mut args.repo_override, &repo_root, mode),
        Command::Papercuts(_) => {}
        Command::Secrets(args) => assign_repo_override(&mut args.repo_override, &repo_root, mode),
        ...
        Command::State(args) => assign_repo_override(&mut args.repo_override, &repo_root, mode),
        ...
        Command::Drafts(args) => assign_repo_override(&mut args.repo_override, &repo_root, mode),
        Command::Draft(args) => assign_repo_override(&mut args.repo_override, &repo_root, mode),
