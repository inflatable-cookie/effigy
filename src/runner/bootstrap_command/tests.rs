...
use support::{
    attach_remote_and_push, bare_remote_path, commit_all, create_root_remote_with_bootstrap,
    create_root_remote_with_optional_missing_child, init_bare_remote, init_git_repo, temp_dir,
};
